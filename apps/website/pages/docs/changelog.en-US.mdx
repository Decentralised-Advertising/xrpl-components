...
export const getStaticProps = ({ params }) => {
  // return fetch(`https://api.github.com/repos/decentralised-advertising/xrpl-components/releases`)
  //   .then(res => res.json())
...
Please visit the [xrpl-components release page](https://github.com/decentralised-advertising/xrpl-components/releases) for the full history of releases.
